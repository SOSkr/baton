...
- **Tier 1 (lean, recomendado — sin pre-compile)**: flag por **reglas sobre metadata que ya existe**, barato:
  ...
  - **Label de review en los cierres del prune**: prune, al cerrar/reclasificar automáticamente, aplica `config.review_label` a esos items — es automático y de alto volumen, ahí el usuario revisa cada decisión.
